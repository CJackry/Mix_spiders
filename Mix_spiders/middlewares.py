...
class MixSpidersSpiderMiddleware(object):
...
class MixSpidersDownloaderMiddleware(object):
    # Not all methods need to be defined. If a method is not defined,
...
class JSPageMiddleware(object):
    ...
    def process_request(self, request, spider):
        if spider.name == 'zhihu':
            browser = webdriver.Chrome(executable_path="Mix_spiders/utils/chromedriver.exe")
